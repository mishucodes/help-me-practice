...
{
    return(
        <section className="bg-primary/5 px-5 py-20 flex flex-col justify-center items-center gap-10 text-center">
            ...
            <div className="flex flex-col gap-2">
                ...
                <span className="opacity-50 text-sm">{trustSection}</span>
            </div>
        </section>
    )
}